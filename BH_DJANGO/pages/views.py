...
def homepage_view(request, *args, **kwargs):
    ...
    census_total = len(df.index)
    context = { 'census_total' : census_total}
    return render(request, "home_screen/home.html", context)

@login_required
def recent_admissions_view(request, *args, **kwargs):
    if request.method == 'POST':
    ...
    if request.method == 'GET':
        ...
        return render(request, "home_screen/recent_admissions.html", context)
